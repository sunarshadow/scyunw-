    ...
    function Scroller(elem, settings) {
        ...
        that.change = function(manual) {
            ...
            if (s.display == 'inline') {
                ...
                // 获取某个时间格式的时间戳
                var stringTime = formatHeader(v) + " 23:59:59";
                ...
                if (parseInt(timestamp2) < parseInt(timestamp)) {
                    alert('您选择的时间已过期，请重新选择');
                    return;
                }

                // 今天23:59:59的时间戳
                var stringTime2 = (new Date()).getFullYear() + "-" + ((new Date()).getMonth() + 1) + "-" + (new Date()).getDate() + " 23:59:59";
                ...
                if (parseInt(timestamp3) < parseInt(timestamp2)) {
                    $('.otherday').removeClass('dayhide');
                    $('.otherday .tt').each(function() {
                        $(this).removeClass('t-show-checked')
                    });
                    $('.otherday .tt').eq(0).addClass('t-show-checked');
                    // alert($('.otherday .tt').eq(0).text());
                    $('.today .tt').each(function() {
                        $(this).removeClass('t-show-checked')
                    });
                    if (!$('.today').hasClass('dayhide')) {
                        $('.today').addClass('dayhide');
                    }
                } else {
                    $('.today').removeClass('dayhide');
                    $(".t-first").eq(0).addClass('t-show-checked');
                    $('.otherday .tt').each(function() {
                        $(this).removeClass('t-show-checked')
                    });
                    if (!$('.otherday').hasClass('dayhide')) {
                        $('.otherday').addClass('dayhide');
                    }
                }
